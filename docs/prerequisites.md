...
1. Install the required dependency packages and the Google Client package ([click here](install-overview.md))
...
8. **Optional:** Connect Gemini API or Agent Platform to enable document summaries and file Q&A ([click here](setup/configure-intelligence.md))
